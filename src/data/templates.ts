...
const mutfakAlt = grup('mutfak-alt', 'alt', ALT, [820, 700, 950], [560, 450, 650], [
  ...
  },
  {
    ...
    aciklama: 'L mutfak köşesi – bir tarafı komşu dolabın arkasında kalır',
    w: [1000, 900, 1250],
    esnek: false,
    ozel: 'kose',
    koseKapakGen: 450,
...
const mutfakUst = grup('mutfak-ust', 'ust', UST, [720, 300, 1100], [320, 250, 400], [
  ...
  { id: 'ust-kose', ad: 'Üst Köşe Dolap (Kör Köşe)', w: [800, 600, 1000], esnek: false, ozel: 'kose', koseKapakGen: 350, columns: [col(raf())], etiket: ['köşe'] },
